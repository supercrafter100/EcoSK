...
public class EffCreateCurrency extends Effect {

    static {
        Skript.registerEffect(EffCreateCurrency.class, "create [a] new currency named %string%");
    }
    ...
    protected void execute(Event e) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(EcoSK.getInstance(), () -> {
            ...
            String sql = String.format("CREATE TABLE IF NOT EXISTS %s ( UUID varchar(255) NOT NULL PRIMARY KEY, AMOUNT bigint NOT NULL DEFAULT 0)", currencyName);
